 ...
 *      INCLUDES
 *********************/
#include "lv_demo_widgets_modified.h"
#include "../lvgl/lvgl_private.h"

#if LV_USE_DEMO_WIDGETS_MODIFIED
...
void lv_demo_widgets_modified(void)
{
    ...
    if(disp_size == DISP_LARGE) {
        ...
        LV_IMAGE_DECLARE(img_lvgl_logo_modified);
        lv_image_set_src(logo, &img_lvgl_logo_modified);
...
static void profile_create(lv_obj_t * parent)
{
    ...
    LV_IMAGE_DECLARE(img_demo_widgets_avatar_modified);
    lv_obj_t * avatar = lv_image_create(panel1);
    lv_image_set_src(avatar, &img_demo_widgets_avatar_modified);
...
//    lv_obj_set_style_pad_hor(chart2_hor_scale, lv_chart_get_first_point_center_offset(chart2), 0);
    ...
    LV_IMAGE_DECLARE(img_demo_widgets_needle_modified);
    scale3_needle = lv_image_create(scale3);
    lv_image_set_src(scale3_needle, &img_demo_widgets_needle_modified);
...
void shop_create(lv_obj_t * parent)
{
    ...
    LV_IMAGE_DECLARE(img_clothes_modified);
    create_shop_item(list, &img_clothes_modified, "Blue T-shirt", "Clothes", "$722");
    create_shop_item(list, &img_clothes_modified, "Blue T-shirt", "Clothes", "$411");
    create_shop_item(list, &img_clothes_modified, "Blue T-shirt", "Clothes", "$917");
    create_shop_item(list, &img_clothes_modified, "Blue T-shirt", "Clothes", "$64");
    create_shop_item(list, &img_clothes_modified, "Blue T-shirt", "Clothes", "$805");
