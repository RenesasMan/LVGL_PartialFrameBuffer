...
/* Actual period: 0.0001 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x2710,
  .duty_cycle_counts = 0x1388, .source_div = (timer_source_div_t) 0, .channel = 1, .p_callback = time_counter_callback,
